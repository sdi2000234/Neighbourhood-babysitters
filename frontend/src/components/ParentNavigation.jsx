        ...
        <div>
    		<div className="navBar">
                ...
                <div className="navOptions">
                    ...
                    <div class="dropdown">
                        <button className={(currentNavPage==='parPay' || currentNavPage==='parEnd') ? 'currentNavPage' : 'parContract'}><a href="./ParentContractPayment" >ΣΥΜΦΩΝΗΤΙΚΟ<img className="arrow" alt="arrow" src={arrow}/></a></button>
                    ...
                    <div class="dropdown">
                        <button className={(currentNavPage==='parHiReq' || currentNavPage==='parHiCon' || currentNavPage==='parHiPay') ? 'currentNavPage' : 'parHistory'}><a href="./RequestHistory" >ΙΣΤΟΡΙΚΟ<img className="arrow" alt="arrow" src={arrow}/></a></button>
                        <div class="dropdown-content">
