    ...
    <div>
      ...
      <div className="parentBar">
        <div className="navOptions">
          ...
          <button className={currentNavPage === 'ParentHireProfessional' ? 'currentNavPage' : 'ParentHireProfessional'}><a href="./ParentHireProfessional">ΠΡΟΣΛΗΨΗ ΕΠΑΓΓΕΛΜΑΤΙΑ</a></button>
          <div className="dropdown">
            <button className={(currentNavPage === 'parPay' || currentNavPage === 'parEnd') ? 'currentNavPage' : 'parContract'}>
              <a href="./ParentContractPayment">ΣΥΜΦΩΝΗΤΙΚΟ<img className="arrow" alt="arrow" src={arrowBlack} /></a>
            </button>
            <div className="dropdown-content">
          ...
          <div className="dropdown">
            <button className={(currentNavPage === 'parHiReq' || currentNavPage === 'parHiCon' || currentNavPage === 'parHiPay') ? 'currentNavPage' : 'parHistory'}>
