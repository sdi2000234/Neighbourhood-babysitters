...
import './HistoryProfessional2.css';
...
function HistoryProfessional2() {
  ...
  return (
    <>
      ...
      <Breadcrumbs page1={"ΙΣΤΟΡΙΚΟ"} link1={"../HistoryProfessional1"} page2={"ΣΥΜΦΩΝΗΤΙΚΑ"}/>
        ...
        <div className='card-header2'>
          ...
          <div>
              <Button 
                ...
                onClick={handleClick}
                variant="contained" 
                className='ButtonHistoryProfessional2'
...
export default HistoryProfessional2;
