  ...
  const steps = [
    {
      title: 'Βήμα 1',
      description:
        'Βρες τον επαγγελματία που θα προσέχει το παιδί σου (2 μηνών έως 2,5 ετών) όπως εσύ επιθυμείς. Δες ποιος είναι κοντά σου, τι εμπειρία έχει, τι υπηρεσίες προσφέρει και επίλεξε τον καλύτερο!',
    },
    {
      title: 'Βήμα 2',
      description:
        'Επίλεξε τον ιδανικό επαγγελματία φροντιστή με βάση το ωρολόγιο πρόγραμμα που εσύ επιλέγεις. Μπορείς να ακυρώσεις ανα πάσα στιγμή το συμφωνητικό. Η πληρωμή γίνεται μέσω Voucher.',
    },
    {
      title: 'Βήμα 3',
      description:
        'Κλείσε το ραντεβού σου και γνωρισε τον επαγγελματία φροντιστή! Είναι καθημερινά σε επικοινωνία μαζί σου και σου στέλνει φωτογραφίες.',
    },
  ];
        ...
        >
          <Container maxWidth="md">
            ...
            <Typography variant="body1">
              Οι γονείς μπορούν εύκολα να βρουν εξειδικευμένους φροντιστές 
          ...
          <Grid container spacing={4} justifyContent="center">
            <Grid item xs={12} sm={6}>
              <Typography variant="h6" fontWeight="bold">
                Γνωρίζεις τους επαγγελματίες φροντιστές.
              </Typography>
              <Typography variant="body1" mt={1}>
                Αναλυτική περιγραφή για το πώς οι επαγγελματίες φροντιστές προβάλλουν τα προφίλ τους
